...
@Injectable()
export class CreditRequestServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    create(body: CreditRequestDto | undefined): Observable<CreditRequestDto> {
        let url_ = this.baseUrl + "/api/services/app/CreditRequest/Create";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CreditRequestDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CreditRequestDto>;
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<CreditRequestDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CreditRequestDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    approve(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CreditRequest/Approve?";
        if (id === null)
    ...
    reject(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CreditRequest/Reject?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return OK
     */
    getByEstado(estado: string | undefined): Observable<CreditRequestDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/CreditRequest/GetByEstado?";
        if (estado === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetByEstado(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetByEstado(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<CreditRequestDtoListResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CreditRequestDtoListResultDto>;
        }));
    }

    protected processGetByEstado(response: HttpResponseBase): Observable<CreditRequestDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CreditRequestDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    get(id: number | undefined): Observable<CreditRequestDto> {
        let url_ = this.baseUrl + "/api/services/app/CreditRequest/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<CreditRequestDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CreditRequestDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/CreditRequest/GetAll?";
        if (sorting === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CreditRequestDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CreditRequestDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<CreditRequestDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CreditRequestDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    update(body: CreditRequestDto | undefined): Observable<CreditRequestDto> {
        let url_ = this.baseUrl + "/api/services/app/CreditRequest/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<CreditRequestDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CreditRequest/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class CreditRequestDto implements ICreditRequestDto {
    id: number;
    ...
    constructor(data?: ICreditRequestDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.montoSolicitado = _data["montoSolicitado"];
            this.plazoMeses = _data["plazoMeses"];
            this.ingresoMensual = _data["ingresoMensual"];
            this.antiguedadLaboral = _data["antiguedadLaboral"];
            this.estado = _data["estado"];
        }
    }

    static fromJS(data: any): CreditRequestDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreditRequestDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["montoSolicitado"] = this.montoSolicitado;
        data["plazoMeses"] = this.plazoMeses;
        data["ingresoMensual"] = this.ingresoMensual;
        data["antiguedadLaboral"] = this.antiguedadLaboral;
        data["estado"] = this.estado;
        return data;
    }

    clone(): CreditRequestDto {
        const json = this.toJSON();
        let result = new CreditRequestDto();
        result.init(json);
        return result;
...
export interface ICreditRequestDto {
    id: number;
    montoSolicitado: number;
    plazoMeses: number;
    ingresoMensual: number;
...
export class CreditRequestDtoListResultDto implements ICreditRequestDtoListResultDto {
    items: CreditRequestDto[] | undefined;

    constructor(data?: ICreditRequestDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(CreditRequestDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): CreditRequestDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreditRequestDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): CreditRequestDtoListResultDto {
        const json = this.toJSON();
        let result = new CreditRequestDtoListResultDto();
        result.init(json);
        return result;
...
export interface ICreditRequestDtoListResultDto {
    items: CreditRequestDto[] | undefined;
}

export class CreditRequestDtoPagedResultDto implements ICreditRequestDtoPagedResultDto {
    items: CreditRequestDto[] | undefined;
    totalCount: number;

    constructor(data?: ICreditRequestDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreditRequestDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreditRequestDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): CreditRequestDtoPagedResultDto {
        const json = this.toJSON();
        let result = new CreditRequestDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ICreditRequestDtoPagedResultDto {
    items: CreditRequestDto[] | undefined;
    totalCount: number;
}
